...
<head>
    ...
    <title>@yield('title', 'Gestion des Étudiants et Évaluations')</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Gestion Académique</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ date('Y') }} <a href="#">Gestion Académique</a>.</strong> Tous droits réservés.
    </footer>
</div>
<!-- ./wrapper -->
